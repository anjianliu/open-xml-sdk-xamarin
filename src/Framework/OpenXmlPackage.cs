...
namespace DocumentFormat.OpenXml.Packaging
{
    ...
    public abstract class OpenXmlPackage : OpenXmlPartContainer, IDisposable
    {
        ...
        public void OpenCore(Package package)
        {
            if (package == null)
            {
        ...
        public void OpenCore(Stream stream, bool readWriteMode)
        {
            if (stream == null)
            {
        ...
        public void OpenCore(string path, bool readWriteMode)
        {
            if (path == null)
            {
